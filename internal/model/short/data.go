...
func NewDataDao(ctx context.Context) *DataDao {
	return &DataDao{shortDao: newShortDao(ctx, conf.MysqlClient, Data{}, conf.RedisClient, Data{}.TableName(), logx.WithContext(ctx))}
}
